...
2026-07-20 · ran · advisors(fgsrcxxccdjqyrpkitmk): 9 error / 583 warn / 152 info · new: 3 · resolved: 1 · open: 2 · 9 ERROR security_definer_view (FG-054, NEW — draft migration 009, blocked steph). Mutable search_path expanded: 9 fns (was 1) — migration 006 updated to cover all. Anon admin RPCs expanded: 21 (was 5) — FG-005 scope updated. 2 public-listing storage buckets: studio-audio + tevo-assets (FG-055, NEW). Admin middleware hardcoded JWT fallback (FG-056, NEW). Auto-fixed: apps/web security headers wired (FG-030 partial), gitleaks pre-commit hook added (FG-042 done).
