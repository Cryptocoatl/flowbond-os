    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', zIndex: 1 }}>
          <div style={{ fontSize: 22, letterSpacing: 8, color: '#f0c66b', textTransform: 'uppercase' }}>Investor Deck · 2026</div>
          <div style={{ fontSize: 96, fontWeight: 700, color: '#f3ecff', letterSpacing: 6, marginTop: 18 }}>FLOWBOND</div>
          <div style={{ fontSize: 30, color: '#c084fc', marginTop: 22, fontStyle: 'italic' }}>The Layer 0 of Life</div>
          <div style={{ fontSize: 18, color: '#a394c2', marginTop: 10 }}>If you can imagine it, you can program it — V. Creativo</div>
        </div>
      </div>
    ),
    { ...size },
