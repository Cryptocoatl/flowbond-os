...
/** Future Flight Tailwind preset — mirrors styles/tokens.css so shadcn/UI
 *  components inherit the brand. Imported by tailwind.config.ts. */
export const futureFlightPreset: Partial<Config> = {
  theme: {
    extend: {
      ...
      boxShadow: {
        'ff-card': 'inset 0 1px 0 rgba(255,255,255,0.03), 0 24px 60px -32px rgba(0,0,0,0.9)',
        'ff-portal':
