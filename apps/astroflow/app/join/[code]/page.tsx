    ...
    <div className="max-w-md mx-auto p-6 mt-16 text-center text-[#ece9e0]">
      {!crew ? (
        ...
        <>
          ...
          <p className="text-[11px] uppercase tracking-[0.3em] text-[#b6abec] mb-2">You&apos;re invited to a crew</p>
          ...
          <p className="text-[#9698a8] mb-6">
            ...
            {crew.owner_handle ? ` · hosted by @${crew.owner_handle}` : ''}
          </p>
          <p className="text-sm text-[#b6b3cf] mb-6 leading-relaxed">
            Joining shares your chart with the crew and lets them weave you into collective charts —
            so you can read each other&apos;s paths and find the best configurations together.
          </p>
