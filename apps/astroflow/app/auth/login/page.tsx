...
// AstralFlow no longer hosts its own auth UI. Login is unified at the FBID hub
// (fbid.flowbond.life); we just bounce there and receive the session back at
// /auth/callback. AstralFlow stays its own app at astro.flowbond.life.
function Redirector() {
...
export default function LoginPage() {
  return (
    <div className="max-w-sm mx-auto p-6 mt-16 text-[#ece9e0]">
      <h1 className="text-3xl font-serif mb-1">Enter AstralFlow</h1>
